...
class Model(object):
    ...
    def build(self):
        ...
        self.outputs = tf.reduce_mean(tensor, 1, keep_dims=True)
...
roc_auc = auc(fpr, tpr)
print("accuracy, sensivity, specificity, fscore, balanced_acc, auc:", acc, sensivity, specificity, fscore, balanced_acc, roc_auc)

results.append([acc, sensivity, specificity, fscore, balanced_acc, roc_auc])
